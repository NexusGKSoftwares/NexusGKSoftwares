...
<div style="border: 1px solid #3EF416; border-radius: 8px; padding: 15px; margin: 15px 0;">
...
<div style="border: 1px solid #3EF416; border-radius: 8px; padding: 15px; margin: 15px 0; background: linear-gradient(135deg, rgba(62, 244, 22, 0.05) 0%, rgba(0, 0, 0, 0.05) 100%);">
...
<div style="border: 2px solid #3EF416; border-radius: 10px; padding: 20px; margin: 20px 0; background: linear-gradient(135deg, rgba(62, 244, 22, 0.1) 0%, rgba(0, 0, 0, 0.1) 100%);">
